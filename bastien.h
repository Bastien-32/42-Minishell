...
void	restore_fds_and_wait_all_children(t_all *all ,pid_t last_pid, int stdin_tmp, int stdout_tmp);
...
void	read_and_write_heredoc_lines(t_ast *node, t_all *all, const char *heredoc_file);
